...
# gcp/image Single Entrypoint and Readability Refactor (Alpha)

**Plan reference:** `gcp-image-refactor-alpha` — cite as **gcp-image-refactor-alpha** or [docs/roadmap/2026-03-15-gcp-image-refactor-alpha.md](docs/roadmap/2026-03-15-gcp-image-refactor-alpha.md). For the same refactor without the alpha/compatibility waiver, see [2026-03-15-gcp-image-refactor.md](2026-03-15-gcp-image-refactor.md).
...
Plan complete and saved to `docs/roadmap/2026-03-15-gcp-image-refactor-alpha.md`.
