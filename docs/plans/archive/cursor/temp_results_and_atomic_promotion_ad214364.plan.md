...
| Manager                    | [remote/code/sk/bmt_manager.py](remote/code/sk/bmt_manager.py) (--results-base-override; write to override path; read previous from canonical)                              |
