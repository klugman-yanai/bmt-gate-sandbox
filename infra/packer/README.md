...
CI: [bmt-image-build.yml](../../.github/workflows/ops/bmt-image-build.yml). Local: copy [example.pkrvars.hcl](example.pkrvars.hcl) → `local.pkrvars.hcl`, set `gcp_project`, `gcp_zone`, `gcs_bucket`, then:
