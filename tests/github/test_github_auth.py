...
from backend.github import github_auth  # type: ignore[import-not-found]
...
class TestGetInstallationTokenFromApp:
    ...
    def test_missing_pyjwt_returns_none(self) -> None:
        with mock.patch("backend.github.github_auth.HAS_JWT", new=False):
    ...
    @mock.patch("backend.github.github_auth.HAS_JWT", new=True)
    @mock.patch("backend.github.github_auth.jwt")
    @mock.patch("backend.github.github_auth.urllib.request.urlopen")
