...
Required variables include: `GCS_BUCKET`, `GCP_WIF_PROVIDER`, `GCP_SA_EMAIL`, `GCP_PROJECT`, `GCP_ZONE`, `BMT_VM_NAME`, and Terraform-exported vars (`BMT_STATUS_CONTEXT`, `BMT_HANDSHAKE_TIMEOUT_SEC`). Optional and secrets are documented in bmt-gcloud.
