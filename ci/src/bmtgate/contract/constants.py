"""Shared constants for the BMT CI package (self-contained; no backend imports)."""
...
# ---------------------------------------------------------------------------
# Gate decision string aliases (derived from enums above)
# ---------------------------------------------------------------------------
