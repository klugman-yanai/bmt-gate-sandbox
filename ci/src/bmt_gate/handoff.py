...
from bmt_gate import config, core, gcs, github
from bmt_gate.actions import gh_endgroup, gh_group, gh_notice, gh_warning
...
class HandoffManager:
    ...
    def write_context(self) -> None:
        from bmt_gate.bmt_config import context_from_env, get_context_path, write_context_to_file
