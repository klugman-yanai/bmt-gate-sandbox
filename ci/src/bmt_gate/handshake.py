...
from bmt_gate import config, core, gcs
from bmt_gate.actions import gh_endgroup, gh_group, gh_notice, write_github_output
from bmt_gate.vm import _as_int, _vm_status, vm_describe, vm_serial_tail, vm_stop
    ...
    def force_clean_vm_restart(self) -> None:
        ...
        if status_before != "TERMINATED":
            try:
                ...
                from bmt_gate.actions import gh_warning
