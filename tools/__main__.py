...
def main() -> None:
    ...
    app.add_typer(build_app, name="build", help="VM image build", rich_help_panel="Infrastructure")
    app.add_typer(bmt_app, name="bmt", help="BMT execution and monitoring", rich_help_panel="BMT")
