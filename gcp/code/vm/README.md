...
2. `startup_entrypoint.sh` executes baked `BMT_REPO_ROOT/vm/run_watcher.sh`.
...
| `shared.sh` | Shared logging helpers; sourced by VM scripts. |
...
3. Roll back startup script if needed:
   - `./gcp/code/vm/rollback_startup_to_inline.sh`
