...
class RuntimeFacade:
    ...
    def _run_plan(self) -> int:
        from backend.runtime.entrypoint import run_plan_mode
    ...
    def _run_task(self) -> int:
        from backend.runtime.entrypoint import run_task_mode
    ...
    def _run_coordinator(self) -> int:
        from backend.runtime.entrypoint import run_coordinator_mode
    ...
    def _run_finalize_failure(self) -> int:
        from backend.runtime.entrypoint import run_finalize_failure_mode
    ...
    def _run_dataset_import() -> int:
        from backend.runtime.entrypoint import run_dataset_import_mode

        return run_dataset_import_mode()

    def _run_local(self) -> int:
        from backend.runtime.entrypoint import run_local_mode
