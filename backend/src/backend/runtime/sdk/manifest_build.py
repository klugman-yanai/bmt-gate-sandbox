...
from backend.runtime.models import BmtManifest, ExecutionConfig, RunnerConfig
...
def build_default_bmt_manifest(
    ...
    *,
    ...
    """
    resolved_id = bmt_id or str(uuid.uuid5(uuid.NAMESPACE_URL, f"https://bmt/{project}/{benchmark_folder_name}"))
    return BmtManifest(
        schema_version=1,
        project=project,
