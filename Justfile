...
# Default: workflow_dispatch on build-and-test.yml. For handoff, internal/trigger-ci (thin), or trigger-ci-dispatch, run `act` with -W yourself or see .github/README.md.
[group('local-ci')]
act:
    #!/usr/bin/env bash
    set -euo pipefail
